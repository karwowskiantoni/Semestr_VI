...
plt.title("absolute quantifier")
plot(lambda x: trapezium_function(x, 0, 0, 1700, 1800), domain(0, 8792))
plot(lambda x: trapezium_function(x, 1500, 1800, 3400, 3600), domain(0, 8792))
plot(lambda x: trapezium_function(x, 3400, 3600, 5200, 5400), domain(0, 8792))
plot(lambda x: trapezium_function(x, 5200, 5400, 7000, 7200), domain(0, 8792))
plot(lambda x: trapezium_function(x, 7000, 7200, 8792, 8792), domain(0, 8792))
plt.legend(["less than 2000", "about 2500", "about 5000", "abot 6500", "more than 7000"])
plt.xlabel("subset size")
plt.ylabel("membership")
plt.show()

plt.title("relative quantifier")
plot(lambda x: gaussian_function(x, 0, 0.1), domain(0, 1))
plot(lambda x: gaussian_function(x, 0.25, 0.1), domain(0, 1))
plot(lambda x: gaussian_function(x, 0.5, 0.07), domain(0, 1))
plot(lambda x: gaussian_function(x, 0.75, 0.1), domain(0, 1))
plot(lambda x: gaussian_function(x, 1, 0.1), domain(0, 1))
plt.legend(["almost none", "minority", "around half", "majority", "almost all"])
plt.xlabel("subset size")
plt.ylabel("membership")
plt.show()
